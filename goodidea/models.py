...
class Item(models.Model):
    ...
    refURL1 = models.URLField(max_length=500, blank=True,null=True)
    refURL2 = models.URLField(max_length=500, blank=True,null=True)
    refURL3 = models.URLField(max_length=500, blank=True,null=True)
