...
class ProjectAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    class ProjectResource(resources.ModelResource):
        class Meta:
            ...
            'client','clientDetail', 'mSatff', 
            'staff1', 'staff2','staff3','assistant1','assistant2', 'assistant3',
            'salesAmount1', 'salesAmount2_inctax', 'salesAmount3_inctax','salesAmount2_notax', 'salesAmount3_notax', 'salesTotal', 'salesTotal_exctax',
            'costAmount1', 'costAmount2_inctax', 'costAmount3_inctax', 'costAmount2_notax', 'costAmount3_notax', 'costTotal', 'costTotal_exctax',
